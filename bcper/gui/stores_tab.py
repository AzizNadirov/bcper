...
class StoresTab(tk.Frame):
    ...
    def _build_ui(self):
        ...
        ttk.Button(toolbar, text="Rclone", command=self._add_rclone).pack(side="left", padx=(0, 4), pady=6)
        ttk.Button(toolbar, text="📂 GDrive", command=self._add_gdrive).pack(side="left", padx=(0, 4), pady=6)
        ttk.Button(toolbar, text="Config rclone", command=self._config_rclone).pack(side="left", padx=(0, 4), pady=6)
